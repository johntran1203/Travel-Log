    ...
    <div>
      ...
      <div className="destinations">
        <div className="destination">
          <h3 className="word">The Block (outlet)</h3>
        ...
        <div className="destination">
          <h3 className="word">Las Vegas EDC</h3>
        ...
        <div className="destination">
          <h3 className="word">San Francisco</h3>
        ...
        <div className="destination">
          <h3 className="word">Joshua Tree</h3>
        ...
        <div className="destination">
          <h3 className="word">San Deigo Zoo</h3>
        ...
        <div className="destination">
          <h3 className="word">Disneyland</h3>
